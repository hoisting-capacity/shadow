package com.shadow.trap.service;

import com.shadow.trap.message.MsgType;
import com.shadow.trap.message.Send2MqMsg;
import com.shadow.trap.service.request.MessageRequest;
import com.shadow.trap.service.request.data.template.DataTemplate;
import com.shadow.trap.service.result.ResponseResult;
...
public class MessageService {
     ...
     * 企业微信发送消息端口
     *
     * @param request 请求参数，必须参照{@link com.shadow.trap.service.request.MessageRequest}格式
     * @return 发送结果 {@link com.shadow.trap.service.result.ResponseResult<String>}
     */
    @PostMapping("/send")
